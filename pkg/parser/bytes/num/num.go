...
func Uint16(endian binary.ByteOrder) parser.Func[byte, uint16] {
	return combinator.Map(bytes.Take(sizeofUint16), endian.Uint16).Expected("uint16")
}
...
func Uint32(endian binary.ByteOrder) parser.Func[byte, uint32] {
	return combinator.Map(bytes.Take(sizeofUint32), endian.Uint32).Expected("uint32")
}
...
func Uint64(endian binary.ByteOrder) parser.Func[byte, uint64] {
	return combinator.Map(bytes.Take(sizeofUint64), endian.Uint64).Expected("uint64")
}
...
func Int16(endian binary.ByteOrder) parser.Func[byte, int16] {
	return combinator.Map(bytes.Take(sizeofInt16), func(b []byte) int16 {
...
func Int32(endian binary.ByteOrder) parser.Func[byte, int32] {
	return combinator.Map(bytes.Take(sizeofInt32), func(b []byte) int32 {
...
func Int64(endian binary.ByteOrder) parser.Func[byte, int64] {
	return combinator.Map(bytes.Take(sizeofInt64), func(b []byte) int64 {
...
func Float32(endian binary.ByteOrder) parser.Func[byte, float32] {
	return combinator.Map(bytes.Take(sizeofFloat32), func(b []byte) float32 {
...
func Float64(endian binary.ByteOrder) parser.Func[byte, float64] {
	return combinator.Map(bytes.Take(sizeofFloat64), func(b []byte) float64 {
